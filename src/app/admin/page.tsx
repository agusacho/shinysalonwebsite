      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link href="/admin/bookings" className="text-sm text-[#D4AF37] hover:underline font-sans flex items-center gap-1">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link href="/admin/contacts" className="text-sm text-[#D4AF37] hover:underline font-sans flex items-center gap-1">
