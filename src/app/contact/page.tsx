    ...
    <main className="min-h-screen bg-background relative overflow-hidden pb-24">
      ...
      <section className="pt-32 pb-16 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <Reveal>
            <h1 className="text-5xl md:text-6xl font-serif text-charcoal font-bold mb-6">Get in Touch</h1>
            <p className="text-xl text-peach-deep font-sans">
              We would love to hear from you. Book an appointment or simply say hello.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            <Reveal direction="left" delay={0.2}>
              <div className="bg-white p-6 rounded-2xl border border-peach-base flex items-start gap-4 hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-sans">Mon-Fri: 9am - 8pm<br/>Sat: 10am - 6pm<br/>Sun: Closed</p>
                </div>
              </div>
            </Reveal>
